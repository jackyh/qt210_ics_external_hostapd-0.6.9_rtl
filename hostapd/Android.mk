...
ifdef CONFIG_DRIVER_RTL
L_CFLAGS += -DCONFIG_DRIVER_RTL
OBJS += hostapd/driver_rtl.c
CONFIG_L2_PACKET=y
endif
...
include $(LOCAL_PATH)/hostapd$(HOSTAPD_VER)/hostapd/clear.mk
